...
function World({ initialcampov = [0, 7, 13], orbitalControllable = false }) {
    let handleButtonClick = () => {};
    const controls = useRef();
    return (
        <Canvas style={{ height: "100vh" }}>
            <PerspectiveCamera makeDefault position={initialcampov} />
            <Suspense fallback={null}>
                ...
                {orbitalControllable ? <OrbitControls ref={controls} /> : null}
